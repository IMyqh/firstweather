...
public class Utility {
	 ...
	 * 解析和处理服务器返回的省级数据
	 */
	public synchronized static boolean handleProvincesResponse(FirstWeatherDB firstWeatherDB,
			String response){
	...
	public static void handlerWeatherResponse(Context context,String response){
		try {
			JSONObject jsonObjict=new JSONObject(response);
			JSONObject weatherInfo=jsonObjict.getJSONObject("weatherinfo");
